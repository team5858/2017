...
public class GearBasket extends Subsystem {
    ...
    double openDegrees = 180.0;
    double closedDegrees = 270.0;
    ...
    public void open() {
    	leftServo.setAngle(openDegrees);
    	rightServo.setAngle(openDegrees);
    }
    
    public void close() {
    	leftServo.setAngle(closedDegrees);
    	rightServo.setAngle(closedDegrees);
    }
}
